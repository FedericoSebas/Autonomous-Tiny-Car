...
def getLaneCurve(img,display=2):
    ...
    curvePoint,imgHist = utlis.getHistogram(imgWarp,display=True,minPer=0.9,region=4)
    curveRaw = curvePoint - midPoint
    # print(curvePoint-midPoint)
...
if __name__ == '__main__':
    cap = cv2.VideoCapture('C:/Users/fede/Documents/src-python/vid1.mp4')
